...
var _props2 = __webpack_require__(14);
...
var Controls = function (_Component) {
    ...
    _createClass(Controls, [{
        ...
        key: 'render',
        value: function render() {
            var paused = this.props.player ? this.props.player.paused : true;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('span', { className: 'icon icon-fast-backward' })
                    ),
                    _react2.default.createElement(
                        'button',
                        {
                    ...
                    _react2.default.createElement(
                        'button',
                        { className: 'btn btn-default' },
                        _react2.default.createElement('span', { className: 'icon icon-fast-forward' })
                    )
                ),
                _react2.default.createElement(
                    'div',
...
Controls.propTypes = {
    onChooseDirectory: _react.PropTypes.func,
    player: _react.PropTypes.element
};
...
var _reactPhotonkit = __webpack_require__(12);

var _reactTreeview = __webpack_require__(45);
...
exports.default = _react2.default.createClass({
    displayName: 'LibraryNav',

    propTypes: {
        library: _react.PropTypes.array,
        groupBy: _react.PropTypes.oneOf(['artist', 'album', 'albumArtist'])
    },
    ...
    render: function render() {
        var groups = _lodash2.default.groupBy(this.props.library, this.props.groupBy);
        var list = _lodash2.default.keys(groups).map(function (key) {
            var members = groups[key].map(function (el) {
                return _react2.default.createElement(
                    'span',
                    { className: 'info' },
                    el.title
            ...
            return _react2.default.createElement(
                ...
                { defaultCollapsed: true, nodeLabel: label },
                members
            );
        });

        return _react2.default.createElement(
            _reactPhotonkit.Pane,
            { ptSize: 'sm', sidebar: true },
            _react2.default.createElement(
                _reactTreeview2.default,
...
var _PlaylistItem = __webpack_require__(30);
...
var Playlist = function (_Component) {
    ...
    _createClass(Playlist, [{
        ...
        value: function render() {
            ...
            var tabs = this.props.playlists.map(function (el) {
                _react2.default.createElement(
                    'div',
                    { className: 'tab-item', key: el.id },
                    _react2.default.createElement('span', {
                        className: 'icon icon-cancel icon-close-tab',
                        onClick: _this2.closePlaylist.bind(null, el.id)
                    }),
                    el.name
                );
            });
            var columns = this.props.list.length ? _.keys(this.props.list[0]) : [];
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactPhotonkit.Content,
                    null,
                    _react2.default.createElement(
                        _reactPhotonkit.Table,
                        null,
                        _react2.default.createElement(
                            'thead',
                            null,
                        ...
                        _react2.default.createElement(
                            ...
                            this.props.list.map(function (el) {
                                return _react2.default.createElement(_PlaylistItem2.default, {
                                    ...
                                    item: el,
                                    key: el.id,
                                    onChoose: _this2.props.onChoose
                                });
                            })
                        )
                    )
...
Playlist.propTypes = {
    ...
    playlists: _react.PropTypes.array,
...
var _props3 = __webpack_require__(14);
...
var _Streamable = __webpack_require__(39);

var _Streamable2 = _interopRequireDefault(_Streamable);

var _Vidme = __webpack_require__(40);

var _Vidme2 = _interopRequireDefault(_Vidme);

var _Wistia = __webpack_require__(42);
...
var _LibraryNav = __webpack_require__(26);

var _LibraryNav2 = _interopRequireDefault(_LibraryNav);
...
var _reactPlayer = __webpack_require__(28);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                _reactPhotonkit.Window,
                null,
                this.props.currentPath.length ? React.createElement('audio', {
                    ref: function ref(c) {
                ...
                React.createElement(
                    _reactPhotonkit.Content,
                    null,
                    React.createElement(_LibraryNav2.default, { library: this.props.library }),
                    React.createElement(_Playlist2.default, {
                        list: this.props.library,
                        onChoose: this.onChoose
                    })
                ),
                React.createElement(_reactPhotonkit.Toolbar, { psType: 'footer' })
            );
        }
    }]);
...
var PlaylistItem = function (_Component) {
    ...
    function PlaylistItem() {
        ...
        var _this = _possibleConstructorReturn(this, (PlaylistItem.__proto__ || Object.getPrototypeOf(PlaylistItem)).call(this));
...
var _fetchJsonp = __webpack_require__(31);

var _fetchJsonp2 = _interopRequireDefault(_fetchJsonp);

var _FilePlayer2 = __webpack_require__(9);
